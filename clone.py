...
class Clone(hass.Hass):

  def initialize(self):
      self.log("Begun, this clone war has...")
      self.run_in(self.update, 0)
      self.run_every(self.update, datetime.datetime.now(), 600)
      
  def update(self, kwargs):
        self.log("Clone Wars still running....")
        list = [
        ...
        'You hold onto friends by keeping your heart \na little softer than your head',
       ...
       'Greed and fear of loss are the roots that \nlead to the tree of evil',
       
       'When surrounded by war, one must eventually choose a side',
       
       'Arrogance diminishes wisdom',
       
       'Truth enlightens the mind, \nbut won’t always bring happiness to your heart',
       ...
       'Fighting a war tests a soldier’s skills, \ndefending his home tests a soldier’s heart',
       ...
       'You can change who you are, \nbut you cannot run from yourself']
        ...
        entity = "sensor.clone_wars"
        quote = random.choice(list)
        self.set_state(entity, state = quote)
